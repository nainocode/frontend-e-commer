                    ...
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center space-x-8">
                            ...
                            <ul className="hidden lg:flex items-center justify-start gap-6 md:gap-8 py-3 sm:justify-center">
                                ...
                                <li>
                                    <Link to="/add-product" title="" className="flex text-sm font-medium text-gray-900 hover:text-primary-700 dark:text-white dark:hover:text-primary-500 hover:bg-gray-900 rounded-md px-2 py-2">
                                        Add Product
                                    </Link>
                                </li>
                                                ...
                                                <div key={index} className='flex justify-around'>
                                                    <div className=" flex justify-between gap-5" >
                                                        ...
                                                        <div>
                                                            ...
                                                            <p className="mt-0.5 text-sm font-normal text-gray-500 dark:text-gray-400">{item.description}</p>
                        ...
                        <div className="flex items-center lg:space-x-2">
                            ...
                            <div onMouseEnter={() => setShowUser(true)} onMouseLeave={() => setShowUser(false)} className="relative">
                                ...
                                <div id="userDropdown1" className={`${showUser ? 'block' : 'hidden'} z-10 w-56 divide-y divide-gray-100 overflow-hidden overflow-y-auto rounded-lg bg-white antialiased shadow dark:divide-gray-600 dark:bg-gray-700 absolute right-0 `}>
                                    ...
                                    <div onClick={() => {signout()}} className="p-2 text-sm font-medium text-gray-900 dark:text-white">
